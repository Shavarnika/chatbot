...
print("Decision Tree Classifier Mean Score:", scores.mean())

model = SVC()
model.fit(x_train, y_train)
print("Support Vector Machine (SVM) Score:", model.score(x_test, y_test))
...
def sec_predict(symptoms_exp):
    df = pd.read_csv('healthcare-chatbot-master\Data\Training.csv')
    X = df.iloc[:, :-1]
    y = df['prognosis']
